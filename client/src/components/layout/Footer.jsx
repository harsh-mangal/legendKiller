          ...
          <div>
            ...
            >
              <img
                src="/logo.png"
                alt="Legend Killer"
                className="h-20 sm:h-28 md:h-32 lg:h-36 w-auto max-w-[340px] sm:max-w-[440px] lg:max-w-[520px] object-contain block"
              />
            </Link>
            <p className="mt-5 max-w-md text-sm leading-7 text-slate-400">
              Legend Killer — The Viper Protocol. High-performance sports
              nutrition engineered for elite bodybuilders, athletes, and fitness
              legends.
            </p>
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-8 sm:grid-cols-3">
            {columns.map((column, index) => (
              ...
              >
                ...
                <ul
                  className={`mt-4 ${index === 2 ? "grid grid-cols-2 gap-x-4 gap-y-2.5 sm:block sm:space-y-2.5" : "space-y-2.5"}`}
                >
