...
export default function PartnerInquiries() {
  ...
  const load = useCallback(async () => {
    ...
    catch (error) { toast.error(getErrorMessage(error, "Partner inquiries could not be loaded.")); }
  ...
  return <div className="space-y-6">
    <PageHeader eyebrow="Wholesale and distribution" title="Partner inquiries" description="Submissions from the Become a Partner form." actions={<Button variant="secondary" onClick={load}><RefreshCw size={17} /> Refresh</Button>} />
